...
fun Home(navController: NavController) {
    ...
    Column(modifier = Modifier
        ...
        for (idx in subscriptions.indices) {
            ...
            BooleanPropertyView(label = stringResource(R.string.ims_status), toggled = isIMSRegistered[idx], trueLabel = stringResource(
                            R.string.registered), falseLabel = stringResource(R.string.unregistered))
        }
    }
}
