...
@Composable
fun BooleanPropertyView(label: String, toggled: Boolean, enabled: Boolean = true, trueLabel: String = stringResource(R.string.yes), falseLabel: String = stringResource(R.string.no), onClick: ((Boolean) -> Unit)? = null) {
    if (onClick != null) {
